...
if ($result->num_rows > 0) {
    ...
    while ($data = $result->fetch_array(MYSQLI_ASSOC)) {
        echo 
            ...
            <td class='center'>$data[nama_saham]</td>
            <td>
            ...
            <div class='dropdown'>
                ...
                <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
                    <a class='dropdown-item' href='alternatif-edit.php?id=".$data['id_saham']."'>Edit</a>
                    <a class='dropdown-item' href='alternatif-hapus.php?id=".$data['id_saham']."'>Hapus</a>
                </div>
            </div>
        </div>
            </td>
                    ...
                    <form action="alternatif-simpan.php" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group"> 
                                <input type="text" name="alternatif" placeholder="" class="form-control" id="alternatif"
                                    required>
                            </div>
                        </div>
